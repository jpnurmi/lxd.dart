...
void main() {
  test('get resources', () async {
    ...
    expect(
        resources.toString(),
        equals(
            'LxdResources(cpu: LxdResourcesCpu(architecture: arm64, sockets: []), memory: LxdResourcesMemory(used: 4125806592, total: 17179869184), gpuCards: [LxdResourcesGpuCard(driver: i915, driverVersion: 5.8.0-36-generic, vendor: Intel Corporation, vendorId: 8086)], networkCards: [LxdResourcesNetworkCard(driver: atlantic, driverVersion: 5.8.0-36-generic, vendor: Aquantia Corp., vendorId: 1d6a)], storageDisks: [LxdResourcesStorageDisk(id: nvme0n1, model: INTEL SSDPEKKW256G7, serial: BTPY63440ARH256D, size: 256060514304, type: nvme)], usbDevices: [LxdResourcesUsbDevice(busAddress: 1, deviceAddress: 3, product: Hermon USB hidmouse Device, productId: 2221, speed: 12.0, vendor: ATEN International Co., Ltd, vendorId: 0557)], pciDevices: [LxdResourcesPciDevice(driver: mgag200, driverVersion: 5.8.0-36-generic, pciAddress: 0000:07:03.0, product: MGA G200eW WPCM450, productId: 0532, vendor: Matrox Electronics Systems Ltd., vendorId: 102b)], system: LxdSystemResources(uuid: SYSTEM-UUID, vendor: SYSTEM-VENDOR, product: SYSTEM-PRODUCT, family: SYSTEM-FAMILY, version: 1.0, sku: SYSTEM-SKU, serial: SYSTEM-SERIAL, type: physical, firmware: LxdFirmware(date: 10/08/2021, vendor: FIRMWARE-VENDOR, version: 1.0), chassis: LxdChassis(serial: CHASSIS-SERIAL, type: Notebook, vendor: CHASSIS-VENDOR, version: 1.0), motherboard: LxdMotherboard(product: MOTHERBOARD-PRODUCT, serial: MOTHERBOARD-SERIAL, vendor: MOTHERBOARD-VENDOR, version: 1.0)))'));
